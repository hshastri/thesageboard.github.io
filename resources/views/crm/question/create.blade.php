        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Questions Information</span>
                </div>
                ...
                <form method="post" action="{{ route('question.store') }}">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control  border-teal" name="question" placeholder="Enter Question" required>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-check form-check-inline" style="top: .5em; left: .5em">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input-styled" name="type" value="1" onclick="enable_multiple_field(this.value)" checked data-fouc>
                                    Radio
                                </label>
                            </div>
                            ...
                            <div class="form-check form-check-inline" style="top: .5em; left: .5em">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input-styled" name="type" value="2" onclick="enable_multiple_field(this.value)" data-fouc>
                                    Select Option
                                </label>
                            </div>
                            ...
                            <div class="form-check form-check-inline" style="top: .5em; left: .5em">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input-styled" name="type" value="3" onclick="enable_multiple_field(this.value)" data-fouc >
                                    Input Field
                                </label>
                            </div>
                    ...
                    <button type="submit" class="btn bg-primary">Save Question</button>
                </form>
            </div>
        </div>
    </div>
