<form method="post" action="{{ route('invite.update',base64_encode($users->id)) }}">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <span class="ml-2 font-size-xs">Note: If status active then this user add to your user list</span>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-link pull-left" data-dismiss="modal">Close</button>
        <a href="{{route('users.reinvite', base64_encode($users->id))}}" class="btn bg-primary" >Re Invitation</a>
